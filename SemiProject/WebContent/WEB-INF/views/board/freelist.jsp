...
<% for(int i=0; i<freeList.size(); i++) { %>
	...
	<tr>
		<td style="border-bottom: 1px solid #ccc; border-right: 0; border-left: 0; height:45px;">
			<%=freeList.get(i).getIdx() %>
		</td>
		
		<td style="border-bottom: 1px solid #ccc; border-right: 0; border-left: 0; height:45px;">
			<a href="./freeview?idx=<%=freeList.get(i).getIdx() %>">
