...
<tr>
	<td>카페이름</td><td><input type="text" name="cafe_name" style="width:100%" placeholder ="예시) 카페 이름" class="form-control"/></td>
</tr>

<!-- <tr><td>카페메뉴</td><td><input type="text" name="cafe_menu" style="width:100%"class="form-control"/></td></tr> -->
<tr>
	<td>카페메뉴</td><td><textarea id="cafe" name="cafe_menu" style="width:100%" placeholder ="예시) 아이스아메리카노, 아이스라떼..." class="form-control"></textarea></td>
</tr>

<tr>
	<td>카페주소</td><td><input type="text" name="cafe_loc" style="width:100%" placeholder ="예시) 서울시 강남구" class="form-control"/></td>
</tr>

<tr>
	<td>전화번호</td><td><input type="text" name="cafe_tel" style="width:100%" placeholder ="예시) 0212345678" class="form-control"/></td>
</tr>

<tr>
	<td>영업시간</td><td><input type="text" name="cafe_time" style="width:100%" placeholder ="예시) 09:00 ~ 18:00" class="form-control"/></td>
</tr>
...
<tr>
	<td>카페 사진 첨부파일</td><td><input type="file" name="file" style="width:100%"/></td>
</tr>
